...
function TestimonialCard({ name, title, img, children, bounds, scrollX, ...props }) {
  let ref = useRef(null)
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden='true'
        className='absolute inset-0 rounded-3xl bg-gradient-to-t from-black from-[calc(7/16*100%)] ring-1 ring-inset ring-zinc-950/10 sm:from-25%'
      />
