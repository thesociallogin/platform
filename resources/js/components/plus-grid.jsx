...
export function PlusGridRow({ className = '', children }) {
  return (
    <div className={clsx(className, 'group/row relative isolate pt-[calc(theme(spacing.2)+1px)] last:pb-[calc(theme(spacing.2)+1px)]')}>
...
export function PlusGridIcon({ className = '', placement }) {
  ...
  return (
    <svg viewBox='0 0 15 15' aria-hidden='true' className={clsx(className, 'absolute size-[15px] fill-white/10', yClass, xClass)}>
